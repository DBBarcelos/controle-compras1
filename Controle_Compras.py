...
def main():
    ...
    # JavaScript para detectar se está em um dispositivo mobile
    components.html(
        """
        <script>
    ...
    if "modo_mobile_auto" not in st.session_state:
        st.session_state.modo_mobile_auto = False
    ...
    if not df.empty:
        ...
        modo_mobile = st.session_state.get("modo_mobile_auto", False)
